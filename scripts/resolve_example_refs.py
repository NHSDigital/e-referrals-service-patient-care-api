...
def resolve_ref_path(ref_path):
    ...
    - From schemas/responses/:      ../../examples/...  (up 2)
    - From schemas/responses/sub/:  ../../../examples/... (up 3)

    All paths contain 'examples/' which maps to
    specification/components/examples/.
    ...
    candidate = os.path.join(SPEC_COMPONENTS_DIR, relative_from_examples)
